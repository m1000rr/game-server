...
${INSTANCE_SERVER_DIR}/game/bin/linuxsteamrt64/cs2 -ip ${SERVER_IP} -port ${SERVER_PORT} +tv_port ${TV_PORT} -dedicated -dev +map de_inferno -usercon +rcon_password ${RCON_PASSWORD} +sv_password ${SERVER_PASSWORD} ${EXTRA_GAME_PARAMS}
